  ...
  return (
    <footer className={clsx (classes.footer, "footer-setting")}>
      ...
      <Box fontSize= "15px" paddingTop="10px" paddingBottom="5px" marginLeft="5px">Sports Betting Calculators</Box>
        <Box fontSize="15px" mb={2}>© Copyright - BettyBoo (2023) - Top Bet Calculator <span className="terms-conditions"> <Link href="#" onClick={onClickTerms} className="terms-setting">
            Terms {"&"} Conditions
        </Link>
       </span></Box>
        </Box>
